...
trait Lifecycle extends js.Object:
  ...
  def onErrorCaptured(callback: js.Function3[js.Any, js.Object | Null, String, Boolean | Unit]): Unit
  def onActivated(callback: js.Function0[Unit]): Unit
  def onDeactivated(callback: js.Function0[Unit]): Unit
  def onServerPrefetch(callback: js.Function0[js.Promise[js.Any]]): Unit
