...
object Vue extends js.Object with AppConstructor with General with Reactivity with Lifecycle with Injection:
  ...
  def computed(options: js.Object): js.Dynamic = js.native
  ...
  // ReactivityUtilities
  def isRef(r: js.Object): js.Dynamic = js.native
  def unref(ref: js.Object): js.Dynamic = js.native
  ...
  def effectScope(detached: js.UndefOr[Boolean]): js.Dynamic = js.native
  ...
  def onErrorCaptured(callback: js.Function3[js.Any, js.Any, String, Boolean | Unit]): Unit = js.native
